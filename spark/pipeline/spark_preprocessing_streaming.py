...
# 8. 각 분기 저장
query_fail = write_stream(df_fail,    "s3a://awsprelab1/fms/analytics/fail")
query_err  = write_stream(df_dataerr, "s3a://awsprelab1/fms/analytics/dataerr")
query_ok   = write_stream(df_correct, "s3a://awsprelab1/fms/analytics/data")
